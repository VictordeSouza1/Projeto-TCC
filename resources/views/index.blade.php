        ...
        <div class="header-center">
         ...
         <div class="header-right">
            <nav class="nav-links">
                ...
                <a href="#" class="nav-link">Pesquisas</a>
                <a href="#" class="nav-link">Loja</a>
                <a href="#" class="nav-link">Recomendações</a>
            </nav>
            </div>
        ...
        <div class="container">
            ...
            <section class="content-section">
                ...
                <div class="card-container">
                    <div class="card">
                        <img src="img/pant.jpg" alt="Plantas" class="card-image">
                    ...
                    <div class="card">
                        <img src="img/dec.jpg" alt="Plantas na decoração" class="card-image">
                    ...
                    <div class="card">
                        <img src="img/remedios.jpg" alt="Remédios Naturais" class="card-image">
